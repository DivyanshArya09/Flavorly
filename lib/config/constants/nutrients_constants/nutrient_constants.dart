...
class NutrientsConstants {
  static List<NutrientModel> allNutrients = [
    NutrientModel(name: 'maxCrabs', unit: generateRandomNumber(50, 100)),
    ...
    NutrientModel(name: 'minVitaminA', unit: generateRandomNumber(0, 40)),
    NutrientModel(name: 'maxVitaminA', unit: generateRandomNumber(40, 100)),
    NutrientModel(name: 'minVitaminC', unit: generateRandomNumber(0, 40)),
    NutrientModel(name: 'maxVitaminC', unit: generateRandomNumber(40, 100)),
    NutrientModel(name: 'minVitaminD', unit: generateRandomNumber(0, 40)),
    NutrientModel(name: 'maxVitaminD', unit: generateRandomNumber(40, 100)),
    NutrientModel(name: 'minVitaminE', unit: generateRandomNumber(0, 40)),
    NutrientModel(name: 'maxVitaminE', unit: generateRandomNumber(40, 100)),
    NutrientModel(name: 'minVitaminK', unit: generateRandomNumber(0, 40)),
